...
const Register = () => {
  ...
  return (
    <div className="absolute h-screen w-screen top-10 sm:flex sm:justify-center sm:items-center">
      <div className="h-full sm:h-fit sm:min-h-[70%] w-full sm:w-[70%] p-4 flex shadow-2xl border rounded-2xl">
        ...
        <form
          className="flex flex-col sm:justify-center sm:items-center w-screen sm:w-1/2"
        ...
        >
          <div className="flex flex-col space-y-4 items-center sm:w-[50%]">
            ...
            <Button className="w-full h-10 rounded-full">Sign In</Button>
